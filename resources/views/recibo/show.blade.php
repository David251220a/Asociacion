                                            ...
                                            <div class="inv--head-section inv--detail-section">
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-sm-6 text-sm-right">
                                                        <p class="inv-list-number"><span class="inv-title">Recibo : </span>
                                                            <span class="inv-number">
                                                                {{$recibo->sucursal}}-{{$recibo->general}}-{{str_pad((string)$recibo->numero, 7, '0', STR_PAD_LEFT)}}
                                                            </span>
                                                        </p>
                                                    </div>
                                                    ...
                                                    <div class="col-sm-6 align-self-center mt-3 text-sm-right">
                                                        <p class="inv-created-date"><span class="inv-title">Factura Fecha : </span> <span class="inv-date">{{$recibo->fecha}}</span></p>
                                                    </div>
                                            ...
                                            <div class="inv--detail-section inv--customer-detail-section">
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-xl-8 col-lg-7 col-md-6 col-sm-4">
                                                        <p class="inv-customer-name">{{$recibo->persona->documento}}</p>
                                                        <p class="inv-customer-name">{{$recibo->persona->nombre}} {{$recibo->persona->apellido}}</p>
                                                        <p class="inv-street-addr"></p>
                                                        <p class="inv-email-address">{{$recibo->persona->email}}</p>
                                                        <p class="inv-email-address">{{$recibo->persona->celular}}</p>
                                                    </div>
                                                        ...
                                                        <tbody>
                                                            @foreach ($data as $item)
                                                                <tr>
                                                                    ...
                                                                    <td class="text-right">
                                                                        {{number_format($item->grabado_10, 0, ',', '.')}}
                                                                    </td>
                                                                    <td class="text-right">
                                                                        {{number_format($item->grabado_5, 0, ',', '.')}}
                                                                    </td>
                                                                </tr>
                                                            @endforeach
                                                        </tbody>
                                                        ...
                                                        <div class="text-sm-right">
                                                            <div class="row">
                                                                ...
                                                                <div class="col-sm-4 col-5">
                                                                    <p class="">{{ number_format($data->sum('total'), 0, ',', '.')}}</p>
                                                                </div>
                                                                <div class="col-sm-8 col-7">
                                                                    <p class="">I.V.A.: </p>
                                                                </div>
                                                                <div class="col-sm-4 col-5">
                                                                    <p class="">{{ number_format($data->sum('iva_5') + $data->sum('iva_10'), 0, ',', '.') }}</p>
                                                                </div>
                                                            </div>
                                                        </div>
                                                    </div>
                            ...
                            <div class="invoice-action-btn">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-xl-12 col-md-3 col-sm-6">
                                        <a href="{{route('pdf.recibo', $recibo)}}" target="__blank" class="btn btn-secondary btn-print  action-print">Imprimir</a>
                                    </div>
                                    <div class="col-xl-12 col-md-3 col-sm-6">
                                        <a href="{{route('recibo.index')}}" class="btn btn-info btn-download">Regresar a Recibos</a>
                                    </div>
                                </div>
                            </div>
